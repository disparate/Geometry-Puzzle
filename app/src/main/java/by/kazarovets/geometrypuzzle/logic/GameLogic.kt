...
class GameLogic {
    ...
    fun getPointsForMovement(
        ...
        return PointsToMove(
            ...
            Log.d("POINTS", " \n from = ${from}, left = ${it.left}, right = ${it.right}")
        }
    }
    ...
    private fun findSidePoint(point: Float, lines: List<Line>, horizontalDirection: Direction, isLeft: Boolean): Point3D? {
...
class PointsToMove(val left: Point3D?, val right: Point3D?)